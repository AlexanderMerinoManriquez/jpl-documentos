...
export default function BarraSesion({ usuario }) {
  ...
  return (
    <div className="flex items-center gap-1.5 rounded-full border border-slate-200/80 bg-white/80 p-1 backdrop-blur">
      ...
      <button type="button" title="Cerrar sesión" className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-slate-400 transition-colors hover:bg-red-50 hover:text-red-600">
        <LogOut size={15} />
      </button>
    </div>
  )
